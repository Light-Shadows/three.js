...
function ViewportInfo(editor) {
	...
	container.add(
		new UIText(strings.getKey("viewport/info/objects")),
		objectsText,
		new UIBreak()
	);
	container.add(
		new UIText(strings.getKey("viewport/info/vertices")),
		verticesText,
		new UIBreak()
	);
	container.add(
		new UIText(strings.getKey("viewport/info/triangles")),
		trianglesText,
		new UIBreak()
	);
	container.add(
		new UIText(strings.getKey("viewport/info/frametime")),
		frametimeText,
		new UIBreak()
	);
